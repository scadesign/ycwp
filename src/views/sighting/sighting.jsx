...
import { compass, cetaceans, belief, activity } from '../../select-data/data';
        ...
        <div className="sighting page">
          ...
          <form onSubmit={this.handleSubmit}>
            <div className="four-up">
              ...
              <Select name="species" tasks={cetaceans} value={species} handleChange={this.handleChange} required label="species" title="species" />

              <Select name="confidence" tasks={belief} value={confidence} handleChange={this.handleChange} required label="confidence" title="confidence" />
            </div>
            ...
            <div className="three-up">
              <Select name="bearing" tasks={compass} value={bearing} handleChange={this.handleChange} required label="bearing" title="Bearing" />

              <Input name="distance" type="number" value={distance} handleChange={this.handleChange} required label="distannce" title="Distance (km)" />

              <Select name="behaviour" tasks={activity} value={behaviour} handleChange={this.handleChange} required label="behaviour" title="Behaviour" />
            </div>
