export default class Environment {
  ...
  addItem(start, end, seaState, swellHeight, glare, vessels, visibility, notes) {
    const item = {
      id: this.numItems,
      start,
      end,
  ...
  updateItem(id, start, end, seaState, SwellHeight, glare, vessels, visibility, notes) {
    ...
    this.items[index].glare = glare;
    this.items[index].vessels = vessels;
