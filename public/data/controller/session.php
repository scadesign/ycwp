...
if (array_key_exists("sessionid", $_GET)) {
    ...
    try {
        ...
        $dB->beginTransaction();
        $query = $dB->prepare('insert into sessions (volunteer, access_token, access_expiry, refresh_token, refresh_expiry) values (:userid, :accesstoken, date_add(NOW(), INTERVAL :accesstokenexpiryseconds SECOND), :refreshtoken, date_add(NOW(), INTERVAL :refreshtokenexpiryseconds SECOND))');
